---
domain: pytorch.org
fetch_date: '2026-05-18T12:35:48.874973'
status: ok
url: https://pytorch.org/blog/flexattention/
---

![a cartoon chart flexing his muscles](https://pytorch.org/wp-content/uploads/2024/11/image-12.jpeg)
...
![Attention variant support diagram](https://pytorch.org/wp-content/uploads/2024/11/image-13.jpeg)
...
![](https://pytorch.org/wp-content/uploads/2024/08/fg3.png)

In code form:

```
Q, K, V: Tensor[batch_size, num_heads, sequence_length, head_dim]
score: Tensor[batch_size, num_heads, sequence_length, sequence_length]
```**=** (Q **@** K) **/** sqrt(head_dim)
...
![math equation](https://pytorch.org/wp-content/uploads/2024/11/image-25.png)
...
![](https://pytorch.org/wp-content/uploads/2024/08/fg5-1024x507.png)

### ALiBi Bias

![alibi bias](https://pytorch.org/wp-content/uploads/2024/11/image-26.png)
...
![](https://pytorch.org/wp-content/uploads/2024/08/fg7-1024x405.png)
...
![Sliding Window Causal diagrams](https://pytorch.org/wp-content/uploads/2024/11/image-27.png)
...
![execution time charts](https://pytorch.org/wp-content/uploads/2024/11/image-30.png)

### PrefixLM

![PrefixLM diagram](https://pytorch.org/wp-content/uploads/2024/11/image-28.png)
...
![blockdiagonal mask](https://pytorch.org/wp-content/uploads/2024/11/image-29.png)
...
![](https://pytorch.org/wp-content/uploads/2024/08/fg12-1024x921.png)
...
does not work directly on`create_block_mask`

due to some unfortunate limitations. However, you can set`_compile=True`
...
: The positions of the KV blocks computed for each query block.For example, here’s a custom BlockMask constructor for`causal_mask`
...
![blockdiagonal mask](https://pytorch.org/wp-content/uploads/2024/11/image-34.png)
...
![distribution chart](https://pytorch.org/wp-content/uploads/2024/11/image-33.png)
...
![flexattention speed chart](https://pytorch.org/wp-content/uploads/2024/11/image-31.png)

![flexattention speed chart](https://pytorch.org/wp-content/uploads/2024/11/image-32.png)
