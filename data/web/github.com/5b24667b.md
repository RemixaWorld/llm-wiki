---
domain: github.com
fetch_date: '2026-05-18T12:36:25.981503'
status: ok
...
download tokenizer.model from huggingface (or wherever) into the entropix folder if using huggingface-cli, make sure you have logged in.
...
NOTES:
If you're using using the torch parts only, you can `export XLA_PYTHON_CLIENT_PREALLOCATE=false`

to prevent jax from doing jax things and hogging your VRAM
For rapid iteration, `jax.jit`

might be too slow. In this case, set:
