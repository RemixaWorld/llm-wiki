---
domain: github.com
fetch_date: '2026-05-18T12:35:56.887122'
status: ok
url: https://github.com/character-ai/prompt-poet?ref=research.character.ai
---
...
, not both - Sections use YAML block scalars (
`|`

) to preserve newlines for proper separation when concatenated - Section contents are automatically concatenated to form the part's content
