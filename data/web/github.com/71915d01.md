---
domain: github.com
fetch_date: '2026-05-18T12:34:49.182840'
status: ok
...
**700K with 8 A100 (Llama2-7B)**.**1M with 16 A100 (Llama2-13B)**.
...
-
Flash attention and its fused cross entropy kernel.

-
USP (yunchang) for its Ulysses implementation and Unified Sequence Parallelism.
...
- Ring attention (Shenggui et al.;Liu et al., and specifically Zilin's implementation)
- Dist flash attention (previously called LightSeq. Li et al.)
- Deepspeed Ulysses (Jacobs et al. and Jiarui's implementation)
