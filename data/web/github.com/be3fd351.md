---
domain: github.com
fetch_date: '2026-05-18T12:35:12.864823'
status: ok
...
By bringing together both of these components, `llmware`
...
For project ideas, please see solutions with dozens of innovative examples.

- 20 OV-optimized encoding models with OVEmbeddingModel class - supports wide of embedding, reranker and classifers, e.g.,
- using_openvino_embedding_model
- using_openvino_reranker_model
- using_openvino_classifier_model

- 7 NPU-optimized models 'ready to run' in Model Catalog - see using-qnn-npu-models example

- Check out the LLMware Industry Bert model series - see industry-bert-models
...
- core install (minimal set of dependencies)
- full install (adds to the core with wider set of related python libraries).
...
**Mix-and-Match**: LLMWare supports 3 text collection databases (Mongo, Postgres, SQLite) and
10 vector databases (Milvus, PGVector-Postgres, Neo4j, Redis, Mongo-Atlas, Qdrant, Faiss, LanceDB, ChromaDB and Pinecone)
...
with other commonly-used libraries.
...
-
**17 Dec 2023: llmware v0.1.12**- dragon-deci-7b added to catalog - RAG-finetuned model on high-performance new 7B model base from Deci
...
-
**8 Dec 2023: llmware v0.1.11**- New fast start examples for high volume Document Ingestion and Embeddings with Milvus.
...
-
**30 Nov 2023: llmware v0.1.10**- Windows added as a supported operating system.
- Further enhancements to native code for stack management.
- Minor defect fixes.

-
**24 Nov 2023: llmware v0.1.9**- Markdown (.md) files are now parsed and treated as text files.
...
-
**17 Nov 2023: llmware v0.1.8**- Enhanced generation performance by allowing each model to specific the trailing space parameter.
...
-
**14 Nov 2023: llmware v0.1.7**- Moved to Python Wheel package format for PyPi distribution to provide seamless installation of native dependencies on all supported platforms.
...
-
**03 Nov 2023: llmware v0.1.6**- Updated packaging to require mongo-c-driver 1.24.4 to temporarily workaround segmentation fault with mongo-c-driver 1.25.
- Updates in python code needed in anticipation of future Windows support.

-
**27 Oct 2023: llmware v0.1.5**- Four new example scripts focused on RAG workflows with small, fine-tuned instruct models that run on a laptop (
`llmware`
...
-
**20 Oct 2023: llmware v0.1.4**- GPU support for Hugging Face models.
- Defect fixes and additional test scripts.

-
**13 Oct 2023: llmware v0.1.3**- MongoDB Atlas Vector Search support.
...
-
**06 Oct 2023: llmware v0.1.1**- Added test scripts to the github repository for regression testing.
...
-
**Privacy Policy**AI.BLOKS.PRIVACY.POLICY.1.3.25.pdf -
**Terms of Service**AI.Bloks.Terms.of.Service.3.3.25.pdf -
**Acceptable Use Policy**Acceptable Use Policy for Model HQ by AI BLOKS LLC.docx
