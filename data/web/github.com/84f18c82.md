---
domain: github.com
fetch_date: '2026-05-18T12:37:49.794008'
status: ok
url: https://github.com/OPPO-PersonalAI/TaskCraft
---

`taskcraft`

is a library for generating difficulty-scalable, multi-tool, and verifiable agentic tasks with execution trajectories. It offers:
...
Before use, set the following environment variables (supports OpenAI-compatible models and third-party tools): For Linux:
...
By default, we rely on OAgents, ensuring seamless execution of taskcraft. However, you're free to deploy your own agent to tailor the experience to your specific needs.
You can add your own agent class in `src/tools/agent_tools.py`
...
Then you can use these agents in the `depth_extend`

function by passing them as parameters.
...
The generated dataset can be found in huggingface.

Welcome to report issues or submit feature requests via Issues. Feel free to contribute code or documentation improvements :).

If you use `TaskCraft`
