---
domain: github.com
fetch_date: '2026-05-18T12:38:22.119248'
status: ok
url: https://github.com/intel/auto-round.git
---

English | 简体中文

If you are using the main branch, please run `export AR_DISABLE_NEW_ARCH=1`

to disable the new architecture, as it is currently not stable.
...
**MTP layer quantization**has been supported in this PR -
[2025/12] The
...
for fast quantization with some accuracy drop for 4 bits. Details are shown in opt_rtn mode
...
to suit your needs. Details are shown in quantization recipes
