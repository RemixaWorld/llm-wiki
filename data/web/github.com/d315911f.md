---
domain: github.com
fetch_date: '2026-05-18T12:34:48.325473'
status: ok
url: https://github.com/center-for-humans-and-machines/transformer-heads
---
...
**The Base Model**- The value model builds on a pre-trained base large language model.
...
**Adding a value head**- The causal language modelling head is removed.
...
**Preparing for QLoRA training**- QLoRA is desired to reduce memory-overhead and enable DDP training.
