---
domain: github.com
fetch_date: '2026-05-18T12:36:03.249501'
status: ok
url: https://github.com/MedicineToken/Medical-Graph-RAG/tree/main
---
...
-
python run.py -dataset mimic_ex -data_path ./dataset/mimic_ex(where you put the dataset) -grained_chunk -ingraphmerge -construct_graph
...
-
python run.py -dataset mimic_ex -data_path ./dataset/mimic_ex(where you put the dataset) -inference
