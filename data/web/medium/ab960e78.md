---
domain: medium.com
fetch_date: '2026-05-18T12:45:44.289829'
status: ok
url: https://medium.com/@infiniflowai/ragflow-enters-agentic-era-4ad96164fbf3
---

# RAGFlow Enters Agentic Era

[ ![InfiniFlow](https://miro.medium.com/v2/resize:fill:64:64/1*VIOVinD7tDsinrVyUvlV9w.png) ](</@infiniflowai?source=post_page---byline--4ad96164fbf3--------------------------------------->)

[InfiniFlow](</@infiniflowai?source=post_page---byline--4ad96164fbf3--------------------------------------->)
...
\- The retrieval stage involves coarse ranking and refined ranking. Refined ranking typically occurs outside the database, as it requires different reranking models. Additionally, user queries would go through the continuous cycle of rewriting according to the user intent recognized by AI models. This process continues until the retrieved answers are to the user’s satisfaction.
