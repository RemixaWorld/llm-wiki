...
fetch_date: '2026-05-18T12:45:57.755043'
status: ok
url: https://levelup.gitconnected.com/self-hosting-a-free-private-google-analytics-alternative-151599e3bdb3
---

# Self-Hosting a Free Private Google Analytics Alternative

## All the data analytics you need, but without the surveillance-like tracking.

[ ![Irtiza Hafiz](https://miro.medium.com/v2/da:true/resize:fill:64:64/0*zyHb8yqCDszgfGj3) ](<https://irtizahafiz.medium.com/?source=post_page---byline--151599e3bdb3--------------------------------------->)

[Irtiza Hafiz](<https://irtizahafiz.medium.com/?source=post_page---byline--151599e3bdb3--------------------------------------->)
...
* [I Finally Decided to Buy A Cloud Server](</i-finally-decided-to-buy-a-cloud-server-58af4474ff8a>)
* [I Finally Figured out Nginx Reverse Proxy](<https://blog.devgenius.io/i-finally-figured-out-nginx-reverse-proxy-b9c050f16db7>)
* [How I Set Up My Private Cloud Server for Development](</how-i-set-up-my-private-cloud-server-for-development-a97e8f177a2d>)
...
``` git clone https://github.com/umami-software/umami.gitcd umamidocker-compose up -d ```
...
```bash export default function MyApp({ Component, pageProps }) { return ( <ChakraProvider theme={theme}> <Head> <title>Irtiza Hafiz</title> <link rel="icon" href="/irtiza-avatar-ayesha.png" /> <script defer src="https://umami.irtizahafiz.com/script.js" data-website-id="67058922–3cc9–48e1–843e-d29e11286402" ></script> </Head> <Component {…pageProps} />; </ChakraProvider> );} ```
