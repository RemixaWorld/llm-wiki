---
domain: medium.com
fetch_date: '2026-05-18T12:50:30.933556'
status: ok
url: https://medium.com/@yugank.aman/deep-dive-into-llm-evaluators-aka-llm-as-a-judge-c34f497edca9
---

# Deep Dive into LLM-evaluators aka “LLM-as-a-Judge”

[ ![Yugank .Aman](https://miro.medium.com/v2/da:true/resize:fill:64:64/0*BVHsZMj15ryXMndl) ](</@yugank.aman?source=post_page---byline--c34f497edca9--------------------------------------->)

[Yugank .Aman](</@yugank.aman?source=post_page---byline--c34f497edca9--------------------------------------->)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*Jya5b_t2d0YI_iZv.png)

_Diagnostic plots for classification tasks (_[_source_](<https://eugeneyan.com/writing/evals/>) _)_
...
![image](https://miro.medium.com/v2/resize:fit:700/0*CjmzRmaO5gFPq-BD.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*mAsYG4LXa7tIGCC_.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*UmuJnorMMzdOPeVg.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*rd0jk9r8OcyI1twv.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*rOzhmbTUDsuohUZ0.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:678/0*S6HBW4JPmI6N_Ten.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*_1M4ugMtjUicauXh.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*snL1gyTAp0hye2gK.jpg)

In the sampling step, they prompted an LLM to generate a hallucinated answer.

![image](https://miro.medium.com/v2/resize:fit:700/0*3jednaWRT9OMbMOw.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*Jo4SlimthmctPr5z.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*qekMqGabJW484OMC.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*T664bmZrz_WrVFML.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:678/0*-uuKDFzQIX9CfCVP.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*y2H_DCWG62gSbCh4.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*nczvgpGVfBC2dMdA.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*0oS67Kl7Zs3PjLvM.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*izZk8KWKj6zUCcJh.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*V5MYVgVD-fJ84X94.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*hR3NpawkEYB50u91.jpg)

They tried various approaches to measure information consistency between the target response and N generated samples, such as BERTScore, multi-choice question answering, natural language inference (NLI), and n-gram metrics.
...
![image](https://miro.medium.com/v2/resize:fit:700/0*y02CBH1oMmxFhBFZ.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*fq5Xnc8SbOgbTdpK.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*4RzQnC85IiJDY_tu.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*MY8gDQgPyE8qlv2v.jpg)

To improve prompt fairness in pairwise comparisons, the authors use gpt-3.5 to optimize the prompt such that the preference for semantically equivalent prompts is ~0.5. They assessed the impact of their approach on summarization (SummEval, NewsRoom) and dialogue (TopicalChat) tasks.
...
![image](https://miro.medium.com/v2/resize:fit:700/0*bzzkhQRmt3n8RHG4.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*dcVRkJpAkQ-pdhY8.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*DCbAwlpuLC2yG7Ct.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*HoBoQ45NfY81zUMt.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*IrexBQ1e6h9u0ST9.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*PJJQThK4sSHMocEI.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*Q00ss0oY-NLjvqtE.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*RHjXsyxbecuQH2q6.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*QgooA2jQu96OcZ5a.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*roBmoJqTtCZBwXRn.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*s_gqZOW26peuv6G0.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:695/0*r2nG_ElucBzUIY16.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:699/0*f7zIRccjfka-h6-y.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*FMCgR0ng_V3fF0CS.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*kMK3A7seU7-Oipnc.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*MEe_SFKjF-1xLnhC.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*2ISrGrTigf7Br5lf.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*M4XqniJ6t4XM1Ftu.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*2-VfkPyBBLdjpJMb.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*p0Vjl9tolwedbSfe.jpg) ![image](https://miro.medium.com/v2/resize:fit:700/0*bkUby1bjUX8ySDEE.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*psF_KTOyMf_XRJf0.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*TXr86iMwmEado1FH.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*qZ19PsAtUtC4ZWop.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*VN0ZJveMAOYjTiPE.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*ikzouDdvMLP7E0pW.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*7rcWUKdwTwHix_-P.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*b8A0CXrZPVBp73pP.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*1uCrC39gvb8V9wec.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*_fwatRYgXzDPt0tb.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*Oe7oSbMb5JW3lnU7.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*AizXqAiG8qeH-Iaz.jpg)

These finetuned LLM-evaluators perform either pairwise comparison or direct scoring.

![image](https://miro.medium.com/v2/resize:fit:700/0*eLUGrbKytTf-vl7e.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*lNLh3pxyNOTzmk3w.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*6w95VOhr4hzzzDe7.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*zq4h-msrLY9Mz2S0.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*kK0O446RrmhB6JHl.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*_dsAUnASR7jePVe9.jpg)
...
``` Your task is to look at the following question, and based on the references provided, determine if the model’s response is correct or incorrect. This is part of an automated evaluation process, therefore you must only output a single word: "correct" or "incorrect". ``` ```yaml Question: Which Australian did Roger Federer defeat to win his first Wimbledon Men’s Singles title in 2003?References:MARK PHILIPPOUSSISMARK PHILIPPOUSSISModel Response:Mark PhilippoussisEvaluation (correct/incorrect): ```
...
![image](https://miro.medium.com/v2/resize:fit:700/0*ECnzWf09veFh-9jF.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*-3CKUJtt1wE7IeRI.jpg)
...
![image](https://miro.medium.com/v2/resize:fit:700/0*TR-xseWeHLpLdGeS.jpg)
...
Thanks for sticking with me till the end! I hope you found this useful. What other resources on LLM-evaluators have you found helpful? Please comment below
