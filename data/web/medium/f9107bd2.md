...
fetch_date: '2026-05-18T12:45:58.923224'
status: ok
url: https://blog.devgenius.io/a-powerful-private-open-source-alternative-to-google-analytics-3eb0dd2c7634
---
...
[ ![Irtiza Hafiz](https://miro.medium.com/v2/da:true/resize:fill:64:64/0*zyHb8yqCDszgfGj3) ](<https://irtizahafiz.medium.com/?source=post_page---byline--3eb0dd2c7634--------------------------------------->)

[Irtiza Hafiz](<https://irtizahafiz.medium.com/?source=post_page---byline--3eb0dd2c7634--------------------------------------->)
...
``` \- Umami as a Google Analytics Alternative- Track Custom Events- Generate Reports- Create Conversion Funnels ```
...
``` umami.track("credit-card-apply-clicked");umami.track(`${cardName}-apply-clicked`); ```
