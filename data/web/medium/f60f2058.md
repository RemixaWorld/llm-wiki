...
fetch_date: '2026-05-18T12:45:51.028812'
status: ok
url: https://levelup.gitconnected.com/i-finally-decided-to-buy-a-cloud-server-58af4474ff8a
---

# I Finally Decided to Buy A Cloud Server

## My online presence now costs me $12 instead of $100 every month.

[ ![Irtiza Hafiz](https://miro.medium.com/v2/da:true/resize:fill:64:64/0*zyHb8yqCDszgfGj3) ](<https://irtizahafiz.medium.com/?source=post_page---byline--58af4474ff8a--------------------------------------->)

[Irtiza Hafiz](<https://irtizahafiz.medium.com/?source=post_page---byline--58af4474ff8a--------------------------------------->)
...
Nginx allows me to set up proxies and reverse proxies, configure SSL certificates, and set up rate limiting. It also supports subdomain routing — say traffic to [irtizahafiz.com](<http://irtizahafiz.com>) will be routed to port 3000 whereas [api.irtizahafiz.com](<http://api.irtizahafiz.com>) will be routed to port 8000 internally.
