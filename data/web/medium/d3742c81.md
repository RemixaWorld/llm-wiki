...
fetch_date: '2026-05-18T12:45:53.338461'
status: ok
url: https://levelup.gitconnected.com/how-i-set-up-my-private-cloud-server-for-development-a97e8f177a2d
---

# How I Set Up My Private Cloud Server for Development

## Docker, Portainer.io, Nginx, Reverse Proxies, Remote VSCode, etc.

[ ![Irtiza Hafiz](https://miro.medium.com/v2/da:true/resize:fill:64:64/0*zyHb8yqCDszgfGj3) ](<https://irtizahafiz.medium.com/?source=post_page---byline--a97e8f177a2d--------------------------------------->)

[Irtiza Hafiz](<https://irtizahafiz.medium.com/?source=post_page---byline--a97e8f177a2d--------------------------------------->)
...
It’s been a month now since I started developing and deploying apps in my **private cloud server**.
...
Author’s VS Code Port Forwarding example
...
[Portainer.io](<http://Portainer.io>) can help greatly with that.

Portainer is a **UI-based** container management software.

Press enter or click to view image in full size

Author’s example Portainer UI
...
Here’s an example with these services running on my cloud server:
...
Now, with Nginx you can set up these reverse proxies based on subdomains:

* [irtizahafiz.com](<http://irtizahafiz.com>) → port 2000
* [umami.irtizahafiz.com](<http://umami.irtizahafiz.com>) → port 3000
* [newsletter.irtizahafiz.com](<http://newsletter.irtizahafiz.com>) → port 4000
* [portainer.irtizahafiz.com](<http://portainer.irtizahafiz.com>) → port 5000
