---
domain: medium.com
fetch_date: '2026-05-18T12:45:04.909229'
status: ok
...
![image](https://miro.medium.com/v2/resize:fit:700/1*21kZewKuwzAH4eVQM5fM1Q.png)

# The Perfect Prompt: A Prompt Engineering Cheat Sheet

## Aug-12th, 2024: Updated, new resources added.

[ ![Maximilian Vogel](https://miro.medium.com/v2/resize:fill:64:64/1*lmHlRIRIVfE_leviIp1iOg.png) ](</@maximilian.vogel?source=post_page---byline--d0b9c62a2bba--------------------------------------->)

[Maximilian Vogel](</@maximilian.vogel?source=post_page---byline--d0b9c62a2bba--------------------------------------->)
...
![The Prompt Engineering Cheat Sheet: The AUTOMAT Framework (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*5RRzmy8Y-pYTSjJjODHBnw.png)
...
![AUTOMAT Framework: An Example (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*CfJIp-G9fsEKQfRfzlCV5A.png)
...
![The Prompt Engineering Cheat Sheet: The CO-STAR framework, see details by Sheila Teo (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:700/1*bk4MFnCG32XUUhwEmySanw.png)
...
![Prompt engineering: Output format (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*plE8AFN3dWPuDOnVFyD9Wg.png)
...
![The Prompt Engineering Cheat Sheet: Output format (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*0LTb5DxU4dftDdL7GPaWmw.png)
...
![The Prompt Engineering Cheat Sheet: Few shot learning (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*9ze2Uo3gpUT2PFkEJVLPyQ.png)
...
![The Prompt Engineering Cheat Sheet: Chain of thought (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*rIUG5lqEYEDf8XNM5kyI_A.png)
...
![The Prompt Engineering Cheat Sheet: Prompt templates (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*aDMDl4-p0022vuv0WIUwdQ.png)

In each step or invocation of the template, the variables are then replaced by actual content.

![The Prompt Engineering Cheat Sheet: Prompt templates (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*EZoCwmGwINZKQA4Yg37oCA.png)
...
![The Prompt Engineering Cheat Sheet: Retrieval augmented generation (RAG) - a step-by-step introduction (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*21qNzn_diZJ1ar2WB6YNVg.png)
...
![The Prompt Engineering Cheat Sheet: Formatting and delimiters (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/0*Lx3EsEXeBwPNXnmy.png)
...
![The Prompt Engineering Cheat Sheet: Components of a complex prompt (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*xXIr70ZL-_usyIOo9mivAw.png)
...
![The Prompt Engineering Cheat Sheet: Multi-prompt approach (image credit: Maximilian Vogel)](https://miro.medium.com/v2/resize:fit:1000/1*fnG8RGab2U3GuQp52MK47g.png)
...
**Join the Generator’s Newsletter:**[**https://medium.com/the-generator/newsletters/ai-in-real-life-the-generator-newsletter**](</the-generator/newsletters/ai-in-real-life-the-generator-newsletter>)
