...
fetch_date: '2026-05-18T12:46:36.669998'
status: ok
url: https://pub.towardsai.net/the-best-practices-of-rag-300e313322e6
---
...
[ ![Florian June](https://miro.medium.com/v2/resize:fill:64:64/1*DmQ3DH2JeAJquvhT_tjVCw.jpeg) ](<https://medium.com/@florian_algo?source=post_page---byline--300e313322e6--------------------------------------->)

[Florian June](<https://medium.com/@florian_algo?source=post_page---byline--300e313322e6--------------------------------------->)
...
* [Re-ranking](</advanced-rag-04-re-ranking-85f6ae8170b1>) (optimizing the order of retrieved documents based on relevance)
...
Figure 3: Results of the Query Classifier. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
* [Semantic-level chunking](</advanced-rag-05-exploring-semantic-chunking-97c12af20a4d>) uses LLM to determine breakpoints, preserving context but taking more time.
...
Figure 4: Comparison of different chunk sizes. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
Figure 5: Comparison of different chunk skills. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
Figure 6: Results for different embedding models on namespace-Pt/msmarco. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
Figure 7: Comparison of Various Vector Databases. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
Figure 8: Results for different retrieval methods on TREC DL19/20. The best result for each method is made bold and the second is underlined. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
After an initial search, a [re-ranking phase](</advanced-rag-04-re-ranking-85f6ae8170b1>) enhances the relevance of the retrieved documents, ensuring the most pertinent information appears at the top of the list. Two main methods are considered:
...
Figure 10: Comparison between different summarization methods. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
Figure 11: Results of generator fine-tuning. Source: [Searching for Best Practices in Retrieval-Augmented Generation](<https://arxiv.org/pdf/2407.01219>)[.](<https://arxiv.org/pdf/2407.01219.>)
...
[ ![Florian June](https://miro.medium.com/v2/resize:fill:40:40/1*DmQ3DH2JeAJquvhT_tjVCw.jpeg) ](<https://medium.com/@florian_algo?source=post_page-----300e313322e6--------------------------------------->)

[Florian June](<https://medium.com/@florian_algo?source=post_page-----300e313322e6--------------------------------------->)

## RAG

[View list](<https://medium.com/@florian_algo/list/rag-1b65363c06db?source=post_page-----300e313322e6--------------------------------------->)
